...
<html lang="pt-br">
    ...
    <body>
        <div class="container">
            <h2 align="center">Cadastro de Fornecedor</h2>
            <form action="{{ route('fornecedor.store') }}" method="post" class="form-horizontal" name="frmcadastro" id="frmcadastro">
            @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="endereco" id="endreco" placeholder="Endereço" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="livraria_id" class="form-select" name="livraria_id" >
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <input type="submit" name="save_fornecedor" value="Salvar fornecedor" class="btn btn-success">
