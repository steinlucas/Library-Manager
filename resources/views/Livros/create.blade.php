...
<html lang="pt-br">
    ...
    <body>
        <div class="container">
            ...
            <form action="{{ route('livros.store') }}" method="post" class="form-horizontal" name="frmcadastro" id="frmcadastro">
            @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="qtd_paginas" id="qtd_paginas" placeholder="Qtd páginas" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="ano_publicacao" id="ano_publicacao" placeholder="Ano publicação" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="genero" id="genero" placeholder="Gênero" required>
                    </div>
                </div>

                <div class="form-group">
                    <label for="Livraria" class="form-label">Livraria</label>
                    <select id="livraria_id" class="form-select" name="livraria_id" style="width:950px">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <input type="submit" name="save_fornecedor" value="Salvar livro" class="btn btn-success">
